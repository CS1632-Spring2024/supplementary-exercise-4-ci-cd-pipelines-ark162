...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		...
		try {
			...
			Cat ret = (Cat) method.invoke(r, 2);		
			
			Assert.assertNull(ret);
			Assert.assertEquals(out.toString(), "Invalid cat ID." + newline);
		} catch (Exception e) {
			fail();
		}	
	}
	...
	public void testListCatsNumCats3() {
		...
		Assert.assertEquals(ret, "ID 1. Jennyanydots" + newline + "ID 2. Old Deuteronomy" + newline + "ID 3. Mistoffelees" + newline);
	...
	public void testRenameFailureNumCats0() {
		...
		Assert.assertNotEquals(c2.getName(), "Garfield");
		Assert.assertEquals(out.toString(), "Invalid cat ID." + newline);
	}
	...
	public void testRenameNumCat3() {
		...
		Assert.assertEquals(c2.getName(), "Garfield");
	...
	public void testRentCatNumCats3() {
		...
		Assert.assertTrue(ret);
		Assert.assertTrue(c2.getRented());
		Assert.assertEquals(out.toString(), "Old Deuteronomy has been rented." + newline);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		Assert.assertFalse(ret);
		Assert.assertTrue(c2.getRented());
		Assert.assertEquals(out.toString(), "Sorry, Old Deuteronomy is not here!" + newline);
	}
	...
	public void testReturnCatNumCats3() {
		...
		Assert.assertTrue(ret);
		Assert.assertFalse(c2.getRented());
		Assert.assertEquals(out.toString(), "Welcome back, Old Deuteronomy!" + newline);
	}
	...
	public void testReturnFailureCatNumCats3() {
		...
		Assert.assertFalse(ret);
		Assert.assertFalse(c2.getRented());
		Assert.assertEquals(out.toString(), "Old Deuteronomy is already here!" + newline);
	}
